...
print("내 이름은" + name + "입니다") # + 는 연결연산자 | 숫자가 들어가면 산술 연산자
print("이 노트북의 무게는 " + str(weight) + "kg입니다") #숫자를 문자화 시켜주는 함수 
...
print(type(floor)) # int는 정수
print(type(weight)) # float은 실수
print(type(name))  # str은
